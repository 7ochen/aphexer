...
const aphexFaceSrcs = [
    new AphexFace("./faces/drukqs.png", 1.5, -0.08),
    // new AphexFace("./faces/face.png", 2, 0.05),
    new AphexFace("./faces/icbyd.png", 1.35, 0.01),
    new AphexFace("./faces/rdj.png", 1.28, -0.08),
    new AphexFace("./faces/syro.png", 1.8, 0),
    new AphexFace("./faces/windowlicker.png", 1.45, -0.08),
];
